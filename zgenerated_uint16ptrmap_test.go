...
func TestUint16PtrMap_Put(t *testing.T) {
	var e1, e2 *uint16
...
func TestUint16PtrMap_Get(t *testing.T) {
	var e1, e2 *uint16
	e := createRandomObject(e1)
	if v, ok := e.(*uint16); ok {
		e1 = v
...
func TestUint16PtrMap_Remove(t *testing.T) {
	var e1, e2 *uint16
	e := createRandomObject(e1)
	if v, ok := e.(*uint16); ok {
		e1 = v
...
func TestUint16PtrMap_Size(t *testing.T) {
	var e1, e2 *uint16
	e := createRandomObject(e1)
	if v, ok := e.(*uint16); ok {
		e1 = v
...
func TestUint16PtrMap_Empty(t *testing.T) {
	var e1, e2 *uint16
	e := createRandomObject(e1)
	if v, ok := e.(*uint16); ok {
		e1 = v
...
func TestUint16PtrMap_Keys(t *testing.T) {
	var e1, e2 *uint16
	e := createRandomObject(e1)
	if v, ok := e.(*uint16); ok {
		e1 = v
...
func TestUint16PtrMap_Values(t *testing.T) {
	var e1, e2 *uint16
	e := createRandomObject(e1)
	if v, ok := e.(*uint16); ok {
		e1 = v
