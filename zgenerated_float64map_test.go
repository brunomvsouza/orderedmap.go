...
func TestFloat64Map_Put(t *testing.T) {
	var e1, e2 float64
...
func TestFloat64Map_Get(t *testing.T) {
	var e1, e2 float64
	e := createRandomObject(e1)
	if v, ok := e.(float64); ok {
		e1 = v
...
func TestFloat64Map_Remove(t *testing.T) {
	var e1, e2 float64
	e := createRandomObject(e1)
	if v, ok := e.(float64); ok {
		e1 = v
...
func TestFloat64Map_Size(t *testing.T) {
	var e1, e2 float64
	e := createRandomObject(e1)
	if v, ok := e.(float64); ok {
		e1 = v
...
func TestFloat64Map_Empty(t *testing.T) {
	var e1, e2 float64
	e := createRandomObject(e1)
	if v, ok := e.(float64); ok {
		e1 = v
...
func TestFloat64Map_Keys(t *testing.T) {
	var e1, e2 float64
	e := createRandomObject(e1)
	if v, ok := e.(float64); ok {
		e1 = v
...
func TestFloat64Map_Values(t *testing.T) {
	var e1, e2 float64
	e := createRandomObject(e1)
	if v, ok := e.(float64); ok {
		e1 = v
