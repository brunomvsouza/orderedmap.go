...
func TestUintptrPtrMap_Put(t *testing.T) {
	var e1, e2 *uintptr
	e := createRandomObject(e1)
	if v, ok := e.(*uintptr); ok {
		e1 = v
	}
...
func TestUintptrPtrMap_Get(t *testing.T) {
	var e1, e2 *uintptr
	e := createRandomObject(e1)
	if v, ok := e.(*uintptr); ok {
		e1 = v
...
func TestUintptrPtrMap_Remove(t *testing.T) {
	var e1, e2 *uintptr
	e := createRandomObject(e1)
	if v, ok := e.(*uintptr); ok {
		e1 = v
...
func TestUintptrPtrMap_Size(t *testing.T) {
	var e1, e2 *uintptr
	e := createRandomObject(e1)
	if v, ok := e.(*uintptr); ok {
		e1 = v
...
func TestUintptrPtrMap_Empty(t *testing.T) {
	var e1, e2 *uintptr
	e := createRandomObject(e1)
	if v, ok := e.(*uintptr); ok {
		e1 = v
...
func TestUintptrPtrMap_Keys(t *testing.T) {
	var e1, e2 *uintptr
	e := createRandomObject(e1)
	if v, ok := e.(*uintptr); ok {
		e1 = v
...
func TestUintptrPtrMap_Values(t *testing.T) {
	var e1, e2 *uintptr
	e := createRandomObject(e1)
	if v, ok := e.(*uintptr); ok {
		e1 = v
