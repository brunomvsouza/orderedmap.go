...
func TestUint32PtrMap_Put(t *testing.T) {
	var e1, e2 *uint32
...
func TestUint32PtrMap_Get(t *testing.T) {
	var e1, e2 *uint32
	e := createRandomObject(e1)
	if v, ok := e.(*uint32); ok {
		e1 = v
...
func TestUint32PtrMap_Remove(t *testing.T) {
	var e1, e2 *uint32
	e := createRandomObject(e1)
	if v, ok := e.(*uint32); ok {
		e1 = v
...
func TestUint32PtrMap_Size(t *testing.T) {
	var e1, e2 *uint32
	e := createRandomObject(e1)
	if v, ok := e.(*uint32); ok {
		e1 = v
...
func TestUint32PtrMap_Empty(t *testing.T) {
	var e1, e2 *uint32
	e := createRandomObject(e1)
	if v, ok := e.(*uint32); ok {
		e1 = v
...
func TestUint32PtrMap_Keys(t *testing.T) {
	var e1, e2 *uint32
	e := createRandomObject(e1)
	if v, ok := e.(*uint32); ok {
		e1 = v
...
func TestUint32PtrMap_Values(t *testing.T) {
	var e1, e2 *uint32
	e := createRandomObject(e1)
	if v, ok := e.(*uint32); ok {
		e1 = v
