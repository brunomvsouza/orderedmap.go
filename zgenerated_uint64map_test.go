...
func TestUint64Map_Put(t *testing.T) {
	var e1, e2 uint64
...
func TestUint64Map_Get(t *testing.T) {
	var e1, e2 uint64
	e := createRandomObject(e1)
	if v, ok := e.(uint64); ok {
		e1 = v
...
func TestUint64Map_Remove(t *testing.T) {
	var e1, e2 uint64
	e := createRandomObject(e1)
	if v, ok := e.(uint64); ok {
		e1 = v
...
func TestUint64Map_Size(t *testing.T) {
	var e1, e2 uint64
	e := createRandomObject(e1)
	if v, ok := e.(uint64); ok {
		e1 = v
...
func TestUint64Map_Empty(t *testing.T) {
	var e1, e2 uint64
	e := createRandomObject(e1)
	if v, ok := e.(uint64); ok {
		e1 = v
...
func TestUint64Map_Keys(t *testing.T) {
	var e1, e2 uint64
	e := createRandomObject(e1)
	if v, ok := e.(uint64); ok {
		e1 = v
...
func TestUint64Map_Values(t *testing.T) {
	var e1, e2 uint64
	e := createRandomObject(e1)
	if v, ok := e.(uint64); ok {
		e1 = v
