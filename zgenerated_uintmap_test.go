...
func TestUintMap_Put(t *testing.T) {
	var e1, e2 uint
...
func TestUintMap_Get(t *testing.T) {
	var e1, e2 uint
	e := createRandomObject(e1)
	if v, ok := e.(uint); ok {
		e1 = v
...
func TestUintMap_Remove(t *testing.T) {
	var e1, e2 uint
	e := createRandomObject(e1)
	if v, ok := e.(uint); ok {
		e1 = v
...
func TestUintMap_Size(t *testing.T) {
	var e1, e2 uint
	e := createRandomObject(e1)
	if v, ok := e.(uint); ok {
		e1 = v
...
func TestUintMap_Empty(t *testing.T) {
	var e1, e2 uint
	e := createRandomObject(e1)
	if v, ok := e.(uint); ok {
		e1 = v
...
func TestUintMap_Keys(t *testing.T) {
	var e1, e2 uint
	e := createRandomObject(e1)
	if v, ok := e.(uint); ok {
		e1 = v
...
func TestUintMap_Values(t *testing.T) {
	var e1, e2 uint
	e := createRandomObject(e1)
	if v, ok := e.(uint); ok {
		e1 = v
