...
func TestInt16Map_Put(t *testing.T) {
	var e1, e2 int16
...
func TestInt16Map_Get(t *testing.T) {
	var e1, e2 int16
	e := createRandomObject(e1)
	if v, ok := e.(int16); ok {
		e1 = v
...
func TestInt16Map_Remove(t *testing.T) {
	var e1, e2 int16
	e := createRandomObject(e1)
	if v, ok := e.(int16); ok {
		e1 = v
...
func TestInt16Map_Size(t *testing.T) {
	var e1, e2 int16
	e := createRandomObject(e1)
	if v, ok := e.(int16); ok {
		e1 = v
...
func TestInt16Map_Empty(t *testing.T) {
	var e1, e2 int16
	e := createRandomObject(e1)
	if v, ok := e.(int16); ok {
		e1 = v
...
func TestInt16Map_Keys(t *testing.T) {
	var e1, e2 int16
	e := createRandomObject(e1)
	if v, ok := e.(int16); ok {
		e1 = v
...
func TestInt16Map_Values(t *testing.T) {
	var e1, e2 int16
	e := createRandomObject(e1)
	if v, ok := e.(int16); ok {
		e1 = v
