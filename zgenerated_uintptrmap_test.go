...
func TestUintPtrMap_Put(t *testing.T) {
	var e1, e2 *uint
...
func TestUintPtrMap_Get(t *testing.T) {
	var e1, e2 *uint
	e := createRandomObject(e1)
	if v, ok := e.(*uint); ok {
		e1 = v
...
func TestUintPtrMap_Remove(t *testing.T) {
	var e1, e2 *uint
	e := createRandomObject(e1)
	if v, ok := e.(*uint); ok {
		e1 = v
...
func TestUintPtrMap_Size(t *testing.T) {
	var e1, e2 *uint
	e := createRandomObject(e1)
	if v, ok := e.(*uint); ok {
		e1 = v
...
func TestUintPtrMap_Empty(t *testing.T) {
	var e1, e2 *uint
	e := createRandomObject(e1)
	if v, ok := e.(*uint); ok {
		e1 = v
...
func TestUintPtrMap_Keys(t *testing.T) {
	var e1, e2 *uint
	e := createRandomObject(e1)
	if v, ok := e.(*uint); ok {
		e1 = v
...
func TestUintPtrMap_Values(t *testing.T) {
	var e1, e2 *uint
	e := createRandomObject(e1)
	if v, ok := e.(*uint); ok {
		e1 = v
