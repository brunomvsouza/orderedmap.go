...
func TestUint16Map_Put(t *testing.T) {
	var e1, e2 uint16
...
func TestUint16Map_Get(t *testing.T) {
	var e1, e2 uint16
	e := createRandomObject(e1)
	if v, ok := e.(uint16); ok {
		e1 = v
...
func TestUint16Map_Remove(t *testing.T) {
	var e1, e2 uint16
	e := createRandomObject(e1)
	if v, ok := e.(uint16); ok {
		e1 = v
...
func TestUint16Map_Size(t *testing.T) {
	var e1, e2 uint16
	e := createRandomObject(e1)
	if v, ok := e.(uint16); ok {
		e1 = v
...
func TestUint16Map_Empty(t *testing.T) {
	var e1, e2 uint16
	e := createRandomObject(e1)
	if v, ok := e.(uint16); ok {
		e1 = v
...
func TestUint16Map_Keys(t *testing.T) {
	var e1, e2 uint16
	e := createRandomObject(e1)
	if v, ok := e.(uint16); ok {
		e1 = v
...
func TestUint16Map_Values(t *testing.T) {
	var e1, e2 uint16
	e := createRandomObject(e1)
	if v, ok := e.(uint16); ok {
		e1 = v
