...
func TestFloat32PtrMap_Put(t *testing.T) {
	var e1, e2 *float32
...
func TestFloat32PtrMap_Get(t *testing.T) {
	var e1, e2 *float32
	e := createRandomObject(e1)
	if v, ok := e.(*float32); ok {
		e1 = v
...
func TestFloat32PtrMap_Remove(t *testing.T) {
	var e1, e2 *float32
	e := createRandomObject(e1)
	if v, ok := e.(*float32); ok {
		e1 = v
...
func TestFloat32PtrMap_Size(t *testing.T) {
	var e1, e2 *float32
	e := createRandomObject(e1)
	if v, ok := e.(*float32); ok {
		e1 = v
...
func TestFloat32PtrMap_Empty(t *testing.T) {
	var e1, e2 *float32
	e := createRandomObject(e1)
	if v, ok := e.(*float32); ok {
		e1 = v
...
func TestFloat32PtrMap_Keys(t *testing.T) {
	var e1, e2 *float32
	e := createRandomObject(e1)
	if v, ok := e.(*float32); ok {
		e1 = v
...
func TestFloat32PtrMap_Values(t *testing.T) {
	var e1, e2 *float32
	e := createRandomObject(e1)
	if v, ok := e.(*float32); ok {
		e1 = v
