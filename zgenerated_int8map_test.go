...
func TestInt8Map_Put(t *testing.T) {
	var e1, e2 int8
...
func TestInt8Map_Get(t *testing.T) {
	var e1, e2 int8
	e := createRandomObject(e1)
	if v, ok := e.(int8); ok {
		e1 = v
...
func TestInt8Map_Remove(t *testing.T) {
	var e1, e2 int8
	e := createRandomObject(e1)
	if v, ok := e.(int8); ok {
		e1 = v
...
func TestInt8Map_Size(t *testing.T) {
	var e1, e2 int8
	e := createRandomObject(e1)
	if v, ok := e.(int8); ok {
		e1 = v
...
func TestInt8Map_Empty(t *testing.T) {
	var e1, e2 int8
	e := createRandomObject(e1)
	if v, ok := e.(int8); ok {
		e1 = v
...
func TestInt8Map_Keys(t *testing.T) {
	var e1, e2 int8
	e := createRandomObject(e1)
	if v, ok := e.(int8); ok {
		e1 = v
...
func TestInt8Map_Values(t *testing.T) {
	var e1, e2 int8
	e := createRandomObject(e1)
	if v, ok := e.(int8); ok {
		e1 = v
