...
func TestRuneMap_Put(t *testing.T) {
	var e1, e2 rune
...
func TestRuneMap_Remove(t *testing.T) {
	var e1, e2 rune
	e := createRandomObject(e1)
	if v, ok := e.(rune); ok {
		e1 = v
...
func TestRuneMap_Size(t *testing.T) {
	var e1, e2 rune
	e := createRandomObject(e1)
	if v, ok := e.(rune); ok {
		e1 = v
...
func TestRuneMap_Empty(t *testing.T) {
	var e1, e2 rune
	e := createRandomObject(e1)
	if v, ok := e.(rune); ok {
		e1 = v
...
func TestRuneMap_Keys(t *testing.T) {
	var e1, e2 rune
	e := createRandomObject(e1)
	if v, ok := e.(rune); ok {
		e1 = v
...
func TestRuneMap_Values(t *testing.T) {
	var e1, e2 rune
	e := createRandomObject(e1)
	if v, ok := e.(rune); ok {
		e1 = v
