...
func TestInt64Map_Put(t *testing.T) {
	var e1, e2 int64
...
func TestInt64Map_Get(t *testing.T) {
	var e1, e2 int64
	e := createRandomObject(e1)
	if v, ok := e.(int64); ok {
		e1 = v
...
func TestInt64Map_Remove(t *testing.T) {
	var e1, e2 int64
	e := createRandomObject(e1)
	if v, ok := e.(int64); ok {
		e1 = v
...
func TestInt64Map_Size(t *testing.T) {
	var e1, e2 int64
	e := createRandomObject(e1)
	if v, ok := e.(int64); ok {
		e1 = v
...
func TestInt64Map_Empty(t *testing.T) {
	var e1, e2 int64
	e := createRandomObject(e1)
	if v, ok := e.(int64); ok {
		e1 = v
...
func TestInt64Map_Keys(t *testing.T) {
	var e1, e2 int64
	e := createRandomObject(e1)
	if v, ok := e.(int64); ok {
		e1 = v
...
func TestInt64Map_Values(t *testing.T) {
	var e1, e2 int64
	e := createRandomObject(e1)
	if v, ok := e.(int64); ok {
		e1 = v
