...
func TestUint8PtrMap_Put(t *testing.T) {
	var e1, e2 *uint8
...
func TestUint8PtrMap_Get(t *testing.T) {
	var e1, e2 *uint8
	e := createRandomObject(e1)
	if v, ok := e.(*uint8); ok {
		e1 = v
...
func TestUint8PtrMap_Remove(t *testing.T) {
	var e1, e2 *uint8
	e := createRandomObject(e1)
	if v, ok := e.(*uint8); ok {
		e1 = v
...
func TestUint8PtrMap_Size(t *testing.T) {
	var e1, e2 *uint8
	e := createRandomObject(e1)
	if v, ok := e.(*uint8); ok {
		e1 = v
...
func TestUint8PtrMap_Empty(t *testing.T) {
	var e1, e2 *uint8
	e := createRandomObject(e1)
	if v, ok := e.(*uint8); ok {
		e1 = v
...
func TestUint8PtrMap_Keys(t *testing.T) {
	var e1, e2 *uint8
	e := createRandomObject(e1)
	if v, ok := e.(*uint8); ok {
		e1 = v
...
func TestUint8PtrMap_Values(t *testing.T) {
	var e1, e2 *uint8
	e := createRandomObject(e1)
	if v, ok := e.(*uint8); ok {
		e1 = v
