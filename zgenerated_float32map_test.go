...
func TestFloat32Map_Put(t *testing.T) {
	var e1, e2 float32
...
func TestFloat32Map_Get(t *testing.T) {
	var e1, e2 float32
	e := createRandomObject(e1)
	if v, ok := e.(float32); ok {
		e1 = v
...
func TestFloat32Map_Remove(t *testing.T) {
	var e1, e2 float32
	e := createRandomObject(e1)
	if v, ok := e.(float32); ok {
		e1 = v
...
func TestFloat32Map_Size(t *testing.T) {
	var e1, e2 float32
	e := createRandomObject(e1)
	if v, ok := e.(float32); ok {
		e1 = v
...
func TestFloat32Map_Empty(t *testing.T) {
	var e1, e2 float32
	e := createRandomObject(e1)
	if v, ok := e.(float32); ok {
		e1 = v
...
func TestFloat32Map_Keys(t *testing.T) {
	var e1, e2 float32
	e := createRandomObject(e1)
	if v, ok := e.(float32); ok {
		e1 = v
...
func TestFloat32Map_Values(t *testing.T) {
	var e1, e2 float32
	e := createRandomObject(e1)
	if v, ok := e.(float32); ok {
		e1 = v
