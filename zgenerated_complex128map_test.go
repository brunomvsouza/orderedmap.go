...
func TestComplex128Map_Put(t *testing.T) {
...
func TestComplex128Map_Get(t *testing.T) {
	var e1, e2 complex128
	e := createRandomObject(e1)
	if v, ok := e.(complex128); ok {
		e1 = v
...
func TestComplex128Map_Remove(t *testing.T) {
	var e1, e2 complex128
	e := createRandomObject(e1)
	if v, ok := e.(complex128); ok {
		e1 = v
...
func TestComplex128Map_Size(t *testing.T) {
	var e1, e2 complex128
	e := createRandomObject(e1)
	if v, ok := e.(complex128); ok {
		e1 = v
...
func TestComplex128Map_Empty(t *testing.T) {
	var e1, e2 complex128
	e := createRandomObject(e1)
	if v, ok := e.(complex128); ok {
		e1 = v
...
func TestComplex128Map_Keys(t *testing.T) {
	var e1, e2 complex128
	e := createRandomObject(e1)
	if v, ok := e.(complex128); ok {
		e1 = v
...
func TestComplex128Map_Values(t *testing.T) {
	var e1, e2 complex128
	e := createRandomObject(e1)
	if v, ok := e.(complex128); ok {
		e1 = v
