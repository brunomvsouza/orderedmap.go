...
func TestUint64PtrMap_Put(t *testing.T) {
	var e1, e2 *uint64
...
func TestUint64PtrMap_Get(t *testing.T) {
	var e1, e2 *uint64
	e := createRandomObject(e1)
	if v, ok := e.(*uint64); ok {
		e1 = v
...
func TestUint64PtrMap_Remove(t *testing.T) {
	var e1, e2 *uint64
	e := createRandomObject(e1)
	if v, ok := e.(*uint64); ok {
		e1 = v
...
func TestUint64PtrMap_Size(t *testing.T) {
	var e1, e2 *uint64
	e := createRandomObject(e1)
	if v, ok := e.(*uint64); ok {
		e1 = v
...
func TestUint64PtrMap_Empty(t *testing.T) {
	var e1, e2 *uint64
	e := createRandomObject(e1)
	if v, ok := e.(*uint64); ok {
		e1 = v
...
func TestUint64PtrMap_Keys(t *testing.T) {
	var e1, e2 *uint64
	e := createRandomObject(e1)
	if v, ok := e.(*uint64); ok {
		e1 = v
...
func TestUint64PtrMap_Values(t *testing.T) {
	var e1, e2 *uint64
	e := createRandomObject(e1)
	if v, ok := e.(*uint64); ok {
		e1 = v
