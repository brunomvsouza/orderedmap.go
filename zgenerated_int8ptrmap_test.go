...
func TestInt8PtrMap_Put(t *testing.T) {
	var e1, e2 *int8
...
func TestInt8PtrMap_Get(t *testing.T) {
	var e1, e2 *int8
	e := createRandomObject(e1)
	if v, ok := e.(*int8); ok {
		e1 = v
...
func TestInt8PtrMap_Remove(t *testing.T) {
	var e1, e2 *int8
	e := createRandomObject(e1)
	if v, ok := e.(*int8); ok {
		e1 = v
...
func TestInt8PtrMap_Size(t *testing.T) {
	var e1, e2 *int8
	e := createRandomObject(e1)
	if v, ok := e.(*int8); ok {
		e1 = v
...
func TestInt8PtrMap_Empty(t *testing.T) {
	var e1, e2 *int8
	e := createRandomObject(e1)
	if v, ok := e.(*int8); ok {
		e1 = v
...
func TestInt8PtrMap_Keys(t *testing.T) {
	var e1, e2 *int8
	e := createRandomObject(e1)
	if v, ok := e.(*int8); ok {
		e1 = v
...
func TestInt8PtrMap_Values(t *testing.T) {
	var e1, e2 *int8
	e := createRandomObject(e1)
	if v, ok := e.(*int8); ok {
		e1 = v
