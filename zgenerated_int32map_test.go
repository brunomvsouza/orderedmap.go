...
func TestInt32Map_Put(t *testing.T) {
	var e1, e2 int32
...
func TestInt32Map_Get(t *testing.T) {
	var e1, e2 int32
	e := createRandomObject(e1)
	if v, ok := e.(int32); ok {
		e1 = v
...
func TestInt32Map_Remove(t *testing.T) {
	var e1, e2 int32
	e := createRandomObject(e1)
	if v, ok := e.(int32); ok {
		e1 = v
...
func TestInt32Map_Size(t *testing.T) {
	var e1, e2 int32
	e := createRandomObject(e1)
	if v, ok := e.(int32); ok {
		e1 = v
...
func TestInt32Map_Empty(t *testing.T) {
	var e1, e2 int32
	e := createRandomObject(e1)
	if v, ok := e.(int32); ok {
		e1 = v
...
func TestInt32Map_Keys(t *testing.T) {
	var e1, e2 int32
	e := createRandomObject(e1)
	if v, ok := e.(int32); ok {
		e1 = v
...
func TestInt32Map_Values(t *testing.T) {
	var e1, e2 int32
	e := createRandomObject(e1)
	if v, ok := e.(int32); ok {
		e1 = v
