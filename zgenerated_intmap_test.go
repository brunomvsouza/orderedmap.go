...
func TestIntMap_Remove(t *testing.T) {
	var e1, e2 int
	e := createRandomObject(e1)
	if v, ok := e.(int); ok {
		e1 = v
...
func TestIntMap_Size(t *testing.T) {
	var e1, e2 int
	e := createRandomObject(e1)
	if v, ok := e.(int); ok {
		e1 = v
...
func TestIntMap_Empty(t *testing.T) {
	var e1, e2 int
	e := createRandomObject(e1)
	if v, ok := e.(int); ok {
		e1 = v
...
func TestIntMap_Values(t *testing.T) {
	var e1, e2 int
	e := createRandomObject(e1)
	if v, ok := e.(int); ok {
		e1 = v
