...
func TestIntPtrMap_Put(t *testing.T) {
	var e1, e2 *int
...
func TestIntPtrMap_Get(t *testing.T) {
	var e1, e2 *int
	e := createRandomObject(e1)
	if v, ok := e.(*int); ok {
		e1 = v
...
func TestIntPtrMap_Remove(t *testing.T) {
	var e1, e2 *int
	e := createRandomObject(e1)
	if v, ok := e.(*int); ok {
		e1 = v
...
func TestIntPtrMap_Size(t *testing.T) {
	var e1, e2 *int
	e := createRandomObject(e1)
	if v, ok := e.(*int); ok {
		e1 = v
...
func TestIntPtrMap_Empty(t *testing.T) {
	var e1, e2 *int
	e := createRandomObject(e1)
	if v, ok := e.(*int); ok {
		e1 = v
...
func TestIntPtrMap_Keys(t *testing.T) {
	var e1, e2 *int
	e := createRandomObject(e1)
	if v, ok := e.(*int); ok {
		e1 = v
...
func TestIntPtrMap_Values(t *testing.T) {
	var e1, e2 *int
	e := createRandomObject(e1)
	if v, ok := e.(*int); ok {
		e1 = v
