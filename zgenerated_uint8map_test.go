...
func TestUint8Map_Put(t *testing.T) {
	var e1, e2 uint8
...
func TestUint8Map_Get(t *testing.T) {
	var e1, e2 uint8
	e := createRandomObject(e1)
	if v, ok := e.(uint8); ok {
		e1 = v
...
func TestUint8Map_Remove(t *testing.T) {
	var e1, e2 uint8
	e := createRandomObject(e1)
	if v, ok := e.(uint8); ok {
		e1 = v
...
func TestUint8Map_Size(t *testing.T) {
	var e1, e2 uint8
	e := createRandomObject(e1)
	if v, ok := e.(uint8); ok {
		e1 = v
...
func TestUint8Map_Empty(t *testing.T) {
	var e1, e2 uint8
	e := createRandomObject(e1)
	if v, ok := e.(uint8); ok {
		e1 = v
...
func TestUint8Map_Keys(t *testing.T) {
	var e1, e2 uint8
	e := createRandomObject(e1)
	if v, ok := e.(uint8); ok {
		e1 = v
...
func TestUint8Map_Values(t *testing.T) {
	var e1, e2 uint8
	e := createRandomObject(e1)
	if v, ok := e.(uint8); ok {
		e1 = v
